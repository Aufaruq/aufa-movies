    ...
    <body>
        <div class="w-full h-auto min-h-screen bg-indigo-900 flex flex-col">
            ...
            <div class="ml-28 mt-8 flex flex-row items-center">
                <span class="font-inter text-white before:font-bold text-xl">Sort</span>

                <div class="relative ml-4">
                    <select class="block appearence-none bg-indigo-900 text-black drop-shadow-[0_0px_4px_rgba(0,0,0,0.25) font-inter py-3 pl-4 pr-8 rounded-lg leading-light focus:outline-none focus:bg-white"
